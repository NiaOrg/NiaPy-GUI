...
#
#     from NiaPyGUI import metadata
#
# However, when we do this, we also import `NiaPyGUI/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'NiaPyGUI_cli = NiaPyGUI.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'NiaPyGUI_gui = NiaPyGUI.gui:entry_point'
        # ]
    }
)
